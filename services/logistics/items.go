...
func (s *ItemsEndpoint) UserHasRights(ctx context.Context, division int, method string) (bool, error) {
...
// Get the Items entitiy in the provided division.
func (s *ItemsEndpoint) Get(ctx context.Context, division int, id *types.GUID) (*Items, error) {
	b, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/logistics/Items", division) // #nosec
...
// New returns an empty Items entity
func (s *ItemsEndpoint) New() *Items {
	return &Items{}
}

// Create the Items entity in the provided division.
func (s *ItemsEndpoint) Create(ctx context.Context, division int, entity *Items) (*Items, error) {
	u, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/logistics/Items", division) // #nosec
	e := &Items{}
...
// Update the Items entity in the provided division.
func (s *ItemsEndpoint) Update(ctx context.Context, division int, entity *Items) (*Items, error) {
	b, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/logistics/Items", division) // #nosec
...
// Delete the Items entity in the provided division.
func (s *ItemsEndpoint) Delete(ctx context.Context, division int, id *types.GUID) error {
	b, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/logistics/Items", division) // #nosec
	u, err := api.AddOdataKeyToURL(b, id)
	if err != nil {
		return err
