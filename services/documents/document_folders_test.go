...
func TestDocumentFoldersEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/documents/DocumentFolders?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/documents/DocumentFolders?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.DocumentFolders.List(context.Background(), 0, true)
	if err != nil {
...
func TestDocumentFoldersEndpoint_List(t *testing.T) {
	...
	entities, err := s.DocumentFolders.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("DocumentFoldersEndpoint.List returned error: %v", err)
	}
