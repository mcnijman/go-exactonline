...
func TestDocumentAttachmentsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/documents/DocumentAttachments?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/documents/DocumentAttachments?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.DocumentAttachments.List(context.Background(), 0, true)
	if err != nil {
...
func TestDocumentAttachmentsEndpoint_List(t *testing.T) {
	...
	entities, err := s.DocumentAttachments.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("DocumentAttachmentsEndpoint.List returned error: %v", err)
	}
