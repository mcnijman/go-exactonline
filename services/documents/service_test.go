...
func TestNewDocumentsService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewDocumentsService(c)
...
func setup() (service *DocumentsService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewDocumentsService(client)
