...
func TestGoodsDeliveriesEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/salesorder/GoodsDeliveries?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/salesorder/GoodsDeliveries?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.GoodsDeliveries.List(context.Background(), 0, true)
	if err != nil {
...
func TestGoodsDeliveriesEndpoint_List(t *testing.T) {
	...
	entities, err := s.GoodsDeliveries.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("GoodsDeliveriesEndpoint.List returned error: %v", err)
	}
