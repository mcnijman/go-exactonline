...
func TestSalesOrderLinesEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/salesorder/SalesOrderLines?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/salesorder/SalesOrderLines?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.SalesOrderLines.List(context.Background(), 0, true)
	if err != nil {
...
func TestSalesOrderLinesEndpoint_List(t *testing.T) {
	...
	entities, err := s.SalesOrderLines.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("SalesOrderLinesEndpoint.List returned error: %v", err)
	}
