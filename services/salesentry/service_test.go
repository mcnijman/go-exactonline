...
func TestNewSalesEntryService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewSalesEntryService(c)
...
func setup() (service *SalesEntryService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewSalesEntryService(client)
