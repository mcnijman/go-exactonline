...
func TestNewCashflowService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewCashflowService(c)
...
func setup() (service *CashflowService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewCashflowService(client)
