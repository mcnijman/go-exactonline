...
func TestPaymentConditionsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/cashflow/PaymentConditions?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/cashflow/PaymentConditions?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.PaymentConditions.List(context.Background(), 0, true)
	if err != nil {
...
func TestPaymentConditionsEndpoint_List(t *testing.T) {
	...
	entities, err := s.PaymentConditions.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("PaymentConditionsEndpoint.List returned error: %v", err)
	}
