...
func TestPurchaseEntriesEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/purchaseentry/PurchaseEntries?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/purchaseentry/PurchaseEntries?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.PurchaseEntries.List(context.Background(), 0, true)
	if err != nil {
...
func TestPurchaseEntriesEndpoint_List(t *testing.T) {
	...
	entities, err := s.PurchaseEntries.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("PurchaseEntriesEndpoint.List returned error: %v", err)
	}
