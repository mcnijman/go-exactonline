...
func TestAssetGroupsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/assets/AssetGroups?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/assets/AssetGroups?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.AssetGroups.List(context.Background(), 0, true)
	if err != nil {
...
func TestAssetGroupsEndpoint_List(t *testing.T) {
	...
	entities, err := s.AssetGroups.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("AssetGroupsEndpoint.List returned error: %v", err)
	}
