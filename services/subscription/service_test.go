...
func setup() (service *SubscriptionService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewSubscriptionService(client)
