...
func TestSubscriptionLineTypesEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/subscription/SubscriptionLineTypes?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/subscription/SubscriptionLineTypes?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.SubscriptionLineTypes.List(context.Background(), 0, true)
	if err != nil {
...
func TestSubscriptionLineTypesEndpoint_List(t *testing.T) {
	...
	entities, err := s.SubscriptionLineTypes.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("SubscriptionLineTypesEndpoint.List returned error: %v", err)
	}
