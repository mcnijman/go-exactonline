...
func TestSubscriptionRestrictionEmployeesEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/subscription/SubscriptionRestrictionEmployees?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/subscription/SubscriptionRestrictionEmployees?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.SubscriptionRestrictionEmployees.List(context.Background(), 0, true)
	if err != nil {
...
func TestSubscriptionRestrictionEmployeesEndpoint_List(t *testing.T) {
	...
	entities, err := s.SubscriptionRestrictionEmployees.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("SubscriptionRestrictionEmployeesEndpoint.List returned error: %v", err)
	}
