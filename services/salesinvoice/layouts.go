...
func (s *LayoutsEndpoint) List(ctx context.Context, division int, all bool) ([]*Layouts, error) {
	var entities []*Layouts
	u, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/salesinvoice/Layouts?$select=*", division) // #nosec
	if all {
