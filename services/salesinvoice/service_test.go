...
func TestNewSalesInvoiceService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewSalesInvoiceService(c)
...
func setup() (service *SalesInvoiceService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewSalesInvoiceService(client)
