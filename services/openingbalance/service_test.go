...
func TestNewOpeningBalanceService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewOpeningBalanceService(c)
...
func setup() (service *OpeningBalanceService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewOpeningBalanceService(client)
