...
func TestNewGeneralService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewGeneralService(c)
	...
	if s.Currencies == nil {
		t.Error("Property Currencies should not be nil")
	}
}
...
func setup() (service *GeneralService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewGeneralService(client)
