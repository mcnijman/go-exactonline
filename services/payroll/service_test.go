...
func TestNewPayrollService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewPayrollService(c)
...
func setup() (service *PayrollService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewPayrollService(client)
