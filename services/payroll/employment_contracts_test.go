...
func TestEmploymentContractsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/payroll/EmploymentContracts?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/payroll/EmploymentContracts?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.EmploymentContracts.List(context.Background(), 0, true)
	if err != nil {
...
func TestEmploymentContractsEndpoint_List(t *testing.T) {
	...
	entities, err := s.EmploymentContracts.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("EmploymentContractsEndpoint.List returned error: %v", err)
	}
