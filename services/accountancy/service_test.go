...
func TestNewAccountancyService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewAccountancyService(c)
...
func setup() (service *AccountancyService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewAccountancyService(client)
