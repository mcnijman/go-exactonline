...
func (s *AddressesEndpoint) List(ctx context.Context, division int, all bool) ([]*Addresses, error) {
	var entities []*Addresses
	u, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/crm/Addresses?$select=*", division) // #nosec
	if all {
