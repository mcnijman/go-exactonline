...
func (s *QuotationLinesEndpoint) List(ctx context.Context, division int, all bool) ([]*QuotationLines, error) {
	var entities []*QuotationLines
	u, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/crm/QuotationLines?$select=*", division) // #nosec
	if all {
