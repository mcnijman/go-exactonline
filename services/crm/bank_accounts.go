...
func (s *BankAccountsEndpoint) List(ctx context.Context, division int, all bool) ([]*BankAccounts, error) {
	var entities []*BankAccounts
	u, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/crm/BankAccounts?$select=*", division) // #nosec
	if all {
