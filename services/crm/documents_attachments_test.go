...
func TestDocumentsAttachmentsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/read/crm/DocumentsAttachments?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/read/crm/DocumentsAttachments?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.DocumentsAttachments.List(context.Background(), 0, true)
	if err != nil {
...
func TestDocumentsAttachmentsEndpoint_List(t *testing.T) {
	...
	entities, err := s.DocumentsAttachments.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("DocumentsAttachmentsEndpoint.List returned error: %v", err)
	}
