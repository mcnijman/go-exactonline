...
func TestOperationResourcesEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/OperationResources?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/OperationResources?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.OperationResources.List(context.Background(), 0, true)
	if err != nil {
...
func TestOperationResourcesEndpoint_List(t *testing.T) {
	...
	entities, err := s.OperationResources.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("OperationResourcesEndpoint.List returned error: %v", err)
	}
