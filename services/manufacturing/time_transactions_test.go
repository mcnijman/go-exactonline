...
func TestTimeTransactionsEndpoint_UserHasRights(t *testing.T) {
	...
	mux.HandleFunc(u.Path, func(w http.ResponseWriter, r *http.Request) {
		...
		if got, want := q.Get("endpoint"), "'manufacturing/TimeTransactions'"; got != want {
...
func TestTimeTransactionsEndpoint_List_all(t *testing.T) {
	...
	opts1.Select.Add("*")
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/TimeTransactions", 0)
	if e != nil {
		t.Errorf("s.client.ResolvePathWithDivision in TimeTransactionsEndpoint.List returned error: %v, with url /api/v1/{division}/manufacturing/TimeTransactions?$select=*", e)
	}
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/TimeTransactions", 0)
	if e2 != nil {
		t.Errorf("s.client.ResolvePathWithDivision in TimeTransactionsEndpoint.List returned error: %v, with url /api/v1/{division}/manufacturing/TimeTransactions?$skiptoken=foo", e2)
	}
...
func TestTimeTransactionsEndpoint_List(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/TimeTransactions", 0)
	if e != nil {
		t.Errorf("s.client.ResolvePathWithDivision in TimeTransactionsEndpoint.List returned error: %v, with url /api/v1/{division}/manufacturing/TimeTransactions", e)
	}
	api.AddListOptionsToURL(u, opts1)
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/TimeTransactions", 0)
	if e2 != nil {
		t.Errorf("s.client.ResolvePathWithDivision in TimeTransactionsEndpoint.List returned error: %v, with url /api/v1/{division}/manufacturing/TimeTransactions", e2)
	}
	api.AddListOptionsToURL(u2, opts2)
...
func TestTimeTransactionsEndpoint_Get(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			&TimeTransactions{ID: s1, MetaData: &api.MetaData{URI: &types.URL{URL: &url.URL{Scheme: "https", Host: "start.exactonline.nl"}}}},
			false,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			b, e := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/TimeTransactions", 0)
			if e != nil {
				t.Errorf("s.client.ResolvePathWithDivision in TimeTransactionsEndpoint.Delete() returned error: %v, with url /api/v1/{division}/manufacturing/TimeTransactions", e)
			}
...
func TestTimeTransactionsEndpoint_Create(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"1",
			args{context.Background(), 0, &TimeTransactions{MetaData: &api.MetaData{URI: &types.URL{URL: &url.URL{Scheme: "https", Host: "start.exactonline.nl"}}}}},
			&TimeTransactions{MetaData: &api.MetaData{URI: &types.URL{URL: &url.URL{Scheme: "https", Host: "start.exactonline.nl"}}}},
			false,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/TimeTransactions", 0)
			if e != nil {
				t.Errorf("s.client.ResolvePathWithDivision in TimeTransactionsEndpoint.Create returned error: %v, with url /api/v1/{division}/manufacturing/TimeTransactions", e)
			}
...
func TestTimeTransactionsEndpoint_Update(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"1",
			args{context.Background(), 0, &TimeTransactions{ID: s1, MetaData: &api.MetaData{URI: &types.URL{URL: &url.URL{Scheme: "https", Host: "start.exactonline.nl"}}}}},
			&TimeTransactions{ID: s1, MetaData: &api.MetaData{URI: &types.URL{URL: &url.URL{Scheme: "https", Host: "start.exactonline.nl"}}}},
			false,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			b, e := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/TimeTransactions", 0)
			if e != nil {
				t.Errorf("s.client.ResolvePathWithDivision in TimeTransactionsEndpoint.Update returned error: %v, with url /api/v1/{division}/manufacturing/TimeTransactions", e)
			}
