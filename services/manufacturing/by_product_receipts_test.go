...
func TestByProductReceiptsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/ByProductReceipts?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/ByProductReceipts?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.ByProductReceipts.List(context.Background(), 0, true)
	if err != nil {
...
func TestByProductReceiptsEndpoint_List(t *testing.T) {
	...
	entities, err := s.ByProductReceipts.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("ByProductReceiptsEndpoint.List returned error: %v", err)
	}
