...
func TestShopOrderMaterialPlansEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/ShopOrderMaterialPlans?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/manufacturing/ShopOrderMaterialPlans?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.ShopOrderMaterialPlans.List(context.Background(), 0, true)
	if err != nil {
...
func TestShopOrderMaterialPlansEndpoint_List(t *testing.T) {
	...
	entities, err := s.ShopOrderMaterialPlans.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("ShopOrderMaterialPlansEndpoint.List returned error: %v", err)
	}
