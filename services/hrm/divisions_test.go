...
func TestDivisionsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/hrm/Divisions?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/hrm/Divisions?$skiptoken=foo", 0)
	if e2 != nil {
