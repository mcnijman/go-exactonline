...
func TestLeaveBuildUpRegistrationsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/hrm/LeaveBuildUpRegistrations?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/hrm/LeaveBuildUpRegistrations?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.LeaveBuildUpRegistrations.List(context.Background(), 0, true)
	if err != nil {
...
func TestLeaveBuildUpRegistrationsEndpoint_List(t *testing.T) {
	...
	entities, err := s.LeaveBuildUpRegistrations.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("LeaveBuildUpRegistrationsEndpoint.List returned error: %v", err)
	}
