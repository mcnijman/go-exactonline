...
func TestAbsenceRegistrationTransactionsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/hrm/AbsenceRegistrationTransactions?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/hrm/AbsenceRegistrationTransactions?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.AbsenceRegistrationTransactions.List(context.Background(), 0, true)
	if err != nil {
...
func TestAbsenceRegistrationTransactionsEndpoint_List(t *testing.T) {
	...
	entities, err := s.AbsenceRegistrationTransactions.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("AbsenceRegistrationTransactionsEndpoint.List returned error: %v", err)
	}
