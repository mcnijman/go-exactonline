...
func TestIndicatorSignalsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/beta/{division}/continuousmonitoring/IndicatorSignals?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/beta/{division}/continuousmonitoring/IndicatorSignals?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.IndicatorSignals.List(context.Background(), 0, true)
	if err != nil {
...
func TestIndicatorSignalsEndpoint_List(t *testing.T) {
	...
	entities, err := s.IndicatorSignals.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("IndicatorSignalsEndpoint.List returned error: %v", err)
	}
