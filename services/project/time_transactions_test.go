...
func TestTimeTransactionsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/project/TimeTransactions?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/project/TimeTransactions?$skiptoken=foo", 0)
	if e2 != nil {
