...
func TestTimeAndBillingEntryRecentProjectsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/read/project/TimeAndBillingEntryRecentProjects?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/read/project/TimeAndBillingEntryRecentProjects?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.TimeAndBillingEntryRecentProjects.List(context.Background(), 0, true)
	if err != nil {
...
func TestTimeAndBillingEntryRecentProjectsEndpoint_List(t *testing.T) {
	...
	entities, err := s.TimeAndBillingEntryRecentProjects.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("TimeAndBillingEntryRecentProjectsEndpoint.List returned error: %v", err)
	}
