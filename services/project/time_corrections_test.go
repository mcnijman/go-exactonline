...
func TestTimeCorrectionsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/project/TimeCorrections?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/project/TimeCorrections?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.TimeCorrections.List(context.Background(), 0, true)
	if err != nil {
...
func TestTimeCorrectionsEndpoint_List(t *testing.T) {
	...
	entities, err := s.TimeCorrections.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("TimeCorrectionsEndpoint.List returned error: %v", err)
	}
