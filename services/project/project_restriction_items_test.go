...
func TestProjectRestrictionItemsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/project/ProjectRestrictionItems?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/project/ProjectRestrictionItems?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.ProjectRestrictionItems.List(context.Background(), 0, true)
	if err != nil {
...
func TestProjectRestrictionItemsEndpoint_List(t *testing.T) {
	...
	entities, err := s.ProjectRestrictionItems.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("ProjectRestrictionItemsEndpoint.List returned error: %v", err)
	}
