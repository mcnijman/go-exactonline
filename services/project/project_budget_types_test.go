...
func TestProjectBudgetTypesEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/project/ProjectBudgetTypes?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/project/ProjectBudgetTypes?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.ProjectBudgetTypes.List(context.Background(), 0, true)
	if err != nil {
...
func TestProjectBudgetTypesEndpoint_List(t *testing.T) {
	...
	entities, err := s.ProjectBudgetTypes.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("ProjectBudgetTypesEndpoint.List returned error: %v", err)
	}
