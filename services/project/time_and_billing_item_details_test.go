...
func TestTimeAndBillingItemDetailsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/read/project/TimeAndBillingItemDetails?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/read/project/TimeAndBillingItemDetails?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.TimeAndBillingItemDetails.List(context.Background(), 0, true)
	if err != nil {
...
func TestTimeAndBillingItemDetailsEndpoint_List(t *testing.T) {
	...
	entities, err := s.TimeAndBillingItemDetails.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("TimeAndBillingItemDetailsEndpoint.List returned error: %v", err)
	}
