...
func (s *ProjectBudgetTypesEndpoint) List(ctx context.Context, division int, all bool, o *api.ListOptions) ([]*ProjectBudgetTypes, error) {
	var entities []*ProjectBudgetTypes
	u, _ := s.client.ResolvePathWithDivision("/api/v1/{division}/project/ProjectBudgetTypes", division) // #nosec
