...
func TestCostTransactionsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/project/CostTransactions?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/project/CostTransactions?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.CostTransactions.List(context.Background(), 0, true)
	if err != nil {
...
func TestCostTransactionsEndpoint_List(t *testing.T) {
	...
	entities, err := s.CostTransactions.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("CostTransactionsEndpoint.List returned error: %v", err)
	}
