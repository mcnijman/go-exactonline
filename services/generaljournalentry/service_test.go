...
func TestNewGeneralJournalEntryService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewGeneralJournalEntryService(c)
...
func setup() (service *GeneralJournalEntryService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewGeneralJournalEntryService(client)
