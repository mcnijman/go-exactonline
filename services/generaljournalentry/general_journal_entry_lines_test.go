...
func TestGeneralJournalEntryLinesEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/generaljournalentry/GeneralJournalEntryLines?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/generaljournalentry/GeneralJournalEntryLines?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.GeneralJournalEntryLines.List(context.Background(), 0, true)
	if err != nil {
...
func TestGeneralJournalEntryLinesEndpoint_List(t *testing.T) {
	...
	entities, err := s.GeneralJournalEntryLines.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("GeneralJournalEntryLinesEndpoint.List returned error: %v", err)
	}
