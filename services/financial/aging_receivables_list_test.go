...
func TestAgingReceivablesListEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/read/financial/AgingReceivablesList?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/read/financial/AgingReceivablesList?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.AgingReceivablesList.List(context.Background(), 0, true)
	if err != nil {
...
func TestAgingReceivablesListEndpoint_List(t *testing.T) {
	...
	entities, err := s.AgingReceivablesList.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("AgingReceivablesListEndpoint.List returned error: %v", err)
	}
