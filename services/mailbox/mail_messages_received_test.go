...
func TestMailMessagesReceivedEndpoint_List_all(t *testing.T) {
	...
	entities, err := s.MailMessagesReceived.List(context.Background(), 0, true, opts1)
	if err != nil {
...
func TestMailMessagesReceivedEndpoint_Get(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			&MailMessagesReceived{ID: s1, MetaData: &api.MetaData{URI: &types.URL{URL: &url.URL{Scheme: "https", Host: "start.exactonline.nl"}}}},
			false,
		},
	}
