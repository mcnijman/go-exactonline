...
func TestNewMailboxService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewMailboxService(c)
...
func setup() (service *MailboxService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewMailboxService(client)
