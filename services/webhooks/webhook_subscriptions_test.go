...
func TestWebhookSubscriptionsEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/webhooks/WebhookSubscriptions?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/webhooks/WebhookSubscriptions?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.WebhookSubscriptions.List(context.Background(), 0, true)
	if err != nil {
...
func TestWebhookSubscriptionsEndpoint_List(t *testing.T) {
	...
	entities, err := s.WebhookSubscriptions.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("WebhookSubscriptionsEndpoint.List returned error: %v", err)
	}
