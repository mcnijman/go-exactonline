...
func TestNewWebhooksService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewWebhooksService(c)
...
func setup() (service *WebhooksService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewWebhooksService(client)
