...
func TestFinancialTransactionLinesEndpoint_List_all(t *testing.T) {
	...
	u, e := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/Financial/TransactionLines?$select=*", 0)
	if e != nil {
	...
	u2, e2 := s.client.ResolvePathWithDivision("/api/v1/{division}/bulk/Financial/TransactionLines?$skiptoken=foo", 0)
	if e2 != nil {
	...
	entities, err := s.FinancialTransactionLines.List(context.Background(), 0, true)
	if err != nil {
...
func TestFinancialTransactionLinesEndpoint_List(t *testing.T) {
	...
	entities, err := s.FinancialTransactionLines.List(context.Background(), 0, false)
	if err != nil {
		t.Errorf("FinancialTransactionLinesEndpoint.List returned error: %v", err)
	}
