...
func (s *SalesOrderSalesOrderLines) GetIdentifier() types.GUID {
	return *s.ID
}

// List the SalesOrderSalesOrderLines entities in the provided divison.
// If all is true, all the paginated results are fetched; if false, list the first page.
func (s *SalesOrderSalesOrderLinesEndpoint) List(ctx context.Context, division int, all bool) ([]*SalesOrderSalesOrderLines, error) {
