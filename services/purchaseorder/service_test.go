...
func TestNewPurchaseOrderService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewPurchaseOrderService(c)
...
func setup() (service *PurchaseOrderService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewPurchaseOrderService(client)
