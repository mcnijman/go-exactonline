...
func TestNewFinancialTransactionService(t *testing.T) {
	c := api.NewClient(nil)
	s := NewFinancialTransactionService(c)
...
func setup() (service *FinancialTransactionService, mux *http.ServeMux, serverURL string, teardown func()) {
	...
	client.BaseURL = url
	service = NewFinancialTransactionService(client)
