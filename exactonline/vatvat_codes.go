...
// VATVATCodesService is responsible for communicating with
// the VATCodes endpoint of the VAT service.
type VATVATCodesService service
...
func (s *VATVATCodesService) List(ctx context.Context, division int, all bool) ([]*VATVATCodes, error) {
