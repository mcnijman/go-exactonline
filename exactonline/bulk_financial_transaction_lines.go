...
// BulkFinancialTransactionLinesService is responsible for communicating with
// the FinancialTransactionLines endpoint of the Bulk service.
type BulkFinancialTransactionLinesService service

// BulkFinancialTransactionLines:
// Service: Bulk
...
// List the FinancialTransactionLines entities in the provided divison.
// If all is true, all the paginated results are fetched; if false, list the first page.
func (s *BulkFinancialTransactionLinesService) List(ctx context.Context, division int, all bool) ([]*BulkFinancialTransactionLines, error) {
